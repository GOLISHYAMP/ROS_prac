...
"""autogenerated by genpy from my_robot_msgs/moveActionResult.msg. Do not edit."""
import codecs
import sys
...
class moveActionResult(genpy.Message):
  _md5sum = "752bbdbbfc45d7415d0aa306f86de94c"
  _type = "my_robot_msgs/moveActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','my_robot_msgs/moveResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.result is None:
        self.result = my_robot_msgs.msg.moveResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = my_robot_msgs.msg.moveResult()
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.result.position,) = _get_struct_d().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
