...
"""autogenerated by genpy from my_robot_msgs/moveActionFeedback.msg. Do not edit."""
import codecs
import sys
...
class moveActionFeedback(genpy.Message):
  _md5sum = "e22e83088c9a8107076b34662045f82a"
  _type = "my_robot_msgs/moveActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','my_robot_msgs/moveFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.feedback is None:
        self.feedback = my_robot_msgs.msg.moveFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = my_robot_msgs.msg.moveFeedback()
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.feedback.current_position,) = _get_struct_d().unpack(str[start:end])
      return self
