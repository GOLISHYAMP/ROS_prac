...
"""autogenerated by genpy from my_robot_msgs/moveAction.msg. Do not edit."""
import codecs
import sys
...
class moveAction(genpy.Message):
  _md5sum = "5b6dcd41470556f3deabbc6aa88be298"
  _type = "my_robot_msgs/moveAction"
...
"""
  ...
  _slot_types = ['my_robot_msgs/moveActionGoal','my_robot_msgs/moveActionResult','my_robot_msgs/moveActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.action_goal is None:
        self.action_goal = my_robot_msgs.msg.moveActionGoal()
      if self.action_result is None:
        self.action_result = my_robot_msgs.msg.moveActionResult()
      if self.action_feedback is None:
        self.action_feedback = my_robot_msgs.msg.moveActionFeedback()
    else:
      self.action_goal = my_robot_msgs.msg.moveActionGoal()
      self.action_result = my_robot_msgs.msg.moveActionResult()
      self.action_feedback = my_robot_msgs.msg.moveActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_2d3I().pack(_x.action_goal.goal.position, _x.action_goal.goal.velocity, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.action_goal.goal.position, _x.action_goal.goal.velocity, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs,) = _get_struct_2d3I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      (self.action_result.result.position,) = _get_struct_d().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      (self.action_feedback.feedback.current_position,) = _get_struct_d().unpack(str[start:end])
      return self
